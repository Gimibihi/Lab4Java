...
public class TgMapx<K,V> extends TgMap<K,V> implements MapADTx<K,V> {
     ...
     * @param baseObj
     */
    public TgMapx(K baseKey, V baseObj) {
     ...
     * @param ht
     */
    public TgMapx(K baseKey, V baseObj, HashType ht) {
     ...
     * @param ht
     */
    public TgMapx(K baseKey, V baseObj, int initialCapacity, HashType ht) {
     ...
     * @param ht
     */
    public TgMapx(K baseKey, V baseObj, int initialCapacity, float loadFactor, HashType ht) {
